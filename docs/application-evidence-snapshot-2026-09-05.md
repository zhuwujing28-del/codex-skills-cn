# Application evidence snapshot - 2026-09-05
...
Checked on 2026-09-05 with GitHub REST metadata, public refs, and workflow
status.

| Repository | Public head | Latest public commit | Stars | Forks | Open issues | Latest validate run |
| --- | --- | --- | ---: | ---: | ---: | --- |
| `zhuwujing28-del/codex-skills-cn` | `fef8f17` | Clarify current release readiness | 1 | 0 | 7 | success on `fef8f17`, 2026-09-01T07:18:19Z |
| `zhuwujing28-del/agent-evals-cn` | `d93b892` | Add independent replay protocol | 1 | 0 | 2 | success on `d93b892`, 2026-09-05T14:48:11Z |
...
- `agent-evals-cn` now includes structured replay results and an independent
  replay protocol that define the evidence needed to review a result across
  environments.
